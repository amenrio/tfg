...
import tlc_utils.common.naming as naming_utils
...
def get_public_nodes():
    ...
    return_list = list(object_list - pipeline_utils.ignored_nodes)
    return return_list
