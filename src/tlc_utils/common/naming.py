...
prepDptTask = {
    ...
    "RIGGING": {"ANIM": "anim", "LAYOUT": "layout", "RIG": "rig"},
    "CLOTH": {"CLOTH": "cloth"},
    "HAIR": {"HAIR": "hair"},
    "SHADING": {"SHADING": "shd"},
    "LIGHTING": {"LOOKDEV": "lkdv", "LIGHTING": "lgt"},
    "FX": {"FX": "fx"},
}
...
srcImgDirs = {"CONCEPT": "00_conceptArt", "TEXTURES": "01_textures"}
...
prodDptTask = {
    ...
    "ANIM": {"ABLK": "ablk", "ABRD": "abrd", "AREF": "aref"},
    "CACHE": {"CACHE": "cache"},
    "FX": {"FX": "fx"},
